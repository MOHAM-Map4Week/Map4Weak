...
public class TipOff extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button update = findViewById(R.id.reg_button);

        update.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                AlertDialog.Builder builder = new AlertDialog.Builder(TipOff.this);
                builder.setTitle("글 등록하기");
...
//                Toast.makeText(TipOff.this, "등록되었습니다.", Toast.LENGTH_SHORT).show();
//                finish();
//            }else
//            {
//                Toast.makeText(TipOff.this, result, Toast.LENGTH_SHORT).show();
//            }
//
//        }
//
...
//
//            String server_url = "http://15.164.252.136/reg_board.php";    // db php 연결?
//
//
//            URL url;
//            String response = "";
